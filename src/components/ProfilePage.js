...
function ProfilePage(props) {
  ...
  //   if (profile.information.hasOwnProperty(key)) {
  //     information.push(<InformationField key={key} fieldTitle={key} fieldValue={profile.information[key]} />);
  //   }
  // }
